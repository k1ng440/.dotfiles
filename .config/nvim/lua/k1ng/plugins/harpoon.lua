return {
  ...
  keys = {
    ...
    { '<leader>hh',      function() require('harpoon.ui').nav_file(1) end,    desc = 'Harpoon marked file 1' },
    { '<leader>hj',      function() require('harpoon.ui').nav_file(2) end,    desc = 'Harpoon marked file 2' },
    { '<leader>hk',      function() require('harpoon.ui').nav_file(3) end,    desc = 'Harpoon marked file 3' },
    { '<leader>hl',      function() require('harpoon.ui').nav_file(4) end,    desc = 'Harpoon marked file 4' },
