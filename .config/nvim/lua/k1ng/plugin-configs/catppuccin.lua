require('catppuccin').setup({
  ...
  custom_highlights = function(C)
    return {
      Comment                      = { fg = C.subtext1, style = { 'italic' } }, -- this is a comment
